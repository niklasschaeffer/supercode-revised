...
- **QA & Testing Focus**: Playwright for E2E testing and visual regression, Chrome DevTools for debugging test failures and performance profiling, Desktop Commander for test execution and file management, Context7 for testing framework patterns (Jest, Vitest, Testing Library), Serena for test organization and dependency management
